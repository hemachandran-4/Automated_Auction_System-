...
public class SoldProducts {
	...
	public SoldProducts(String product_name, int seller_id, int product_price, boolean disputed,
			Date product_added_date, Date product_last_date, boolean availability, int min_bid_amount, boolean sold,
			int buyer_id, int product_selling_price) {
		super();
	...
	public String toString() {
		return "SoldProducts [product_name=" + product_name + ", seller_id=" + seller_id + ", product_price="
				+ product_price + ", disputed=" + disputed + ", product_added_date=" + product_added_date
				+ ", product_last_date=" + product_last_date + ", availability=" + availability + ", min_bid_amount="
				+ min_bid_amount + ", sold=" + sold + ", buyer_id=" + buyer_id + ", product_selling_price="
