...
public class ProductFull {
	...
	public String toString() {
		return "ProductFull [product_id=" + product_id + ", product_name=" + product_name + ", seller_id=" + seller_id
				+ ", product_price=" + product_price + ", disputed=" + disputed + ", product_added_date="
				+ product_added_date + ", product_last_date=" + product_last_date + ", availability=" + availability
				+ ", min_bid_amount=" + min_bid_amount + ", sold=" + sold + ", buyer_id=" + buyer_id + "]";
	}
	public ProductFull(int product_id, String product_name, int seller_id, int product_price, boolean disputed,
